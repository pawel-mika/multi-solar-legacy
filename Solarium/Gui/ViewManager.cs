...
namespace Solarium.Gui
{
	...
	public class ViewManager
	{
		...
		private BaseViewPlugin focusedViewPlugin = null;
		public BaseViewPlugin FocusedViewPlugin {
		...
		private void onPluginFocused(object sender, PluginEventArgs e){
			if(e.Plugin is BaseViewPlugin){
				selectPluginTab((BaseViewPlugin)e.Plugin);
			}
		...
		public void PluginWasActivated (BasePlugin plugin){
		...
		/// </summary>
		/// <param name="vp"></param>
		private void selectPluginTab(BaseViewPlugin vp){
		...
		private void generateMenu(){
			...
			foreach(BasePlugin vp in mf.PluginHost.ActivePlugins){
		...
		/// </summary>
		/// <param name="vp"></param>
		public void removePlugin(BaseViewPlugin vp){
			if(vp==null){
